document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getOrCreateErrorElement(field) {
      const fieldWrapper = field.closest('.form-group, .field-wrapper, .input-wrapper') || field.parentElement;
    ...
    function validateField(field) {
      ...
      if (fieldType === 'tel' && !VALIDATORS.phone(value)) {
        showError(field, ERROR_MESSAGES.phone);
        return false;
      }

      if (minLength && !VALIDATORS.minLength(value, minLength)) {
        showError(field, ERROR_MESSAGES.minLength);
        return false;
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Torah Legends Studio - הדרת קודש משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '27fe9bd3-c1ef-46f9-836f-5f797558a94b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '27fe9bd3-c1ef-46f9-836f-5f797558a94b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '27fe9bd3-c1ef-46f9-836f-5f797558a94b';
